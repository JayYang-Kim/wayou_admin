...
<script type="text/javascript">
    function check() {
        ...
        if(mode=="created") {
    		f.action="<%=cp%>/hotel/event/insertEvent";
    	}
			  ...
			  <table style="width: 100%; margin: 0px auto; border-spacing: 0px;">
			     <tr height="45"> 
			      <td align="center" >
			        ...
			        <button type="button" class="btn" onclick="javascript:location.href='<%=cp%>/hotel/event/listEvent';">${mode=='update'?'수정취소':'등록취소'}</button>
