...
<div class="page_info">
	<h2>회원관리</h2>
	<p><strong>블랙리스트</strong></p>
</div>

<div class="list_search_wrap">
	<div class="search_clean">
		<button type="button" class="button" onclick="location.href='<%=cp%>/member/black/list'">새로고침</button>
	</div>
	<form name="search_form" action="<%=cp%>/member/black/list" method="post">
