	...
	<p><strong>이벤트관리</strong></p>
		...
		<table style="width: 100%; margin: 20px auto 0px; border-spacing: 0px;">
		   <tr height="35">
		      ...
		      <td align="center">
		        <form name="searchForm" action="<%=cp%>/store/event/listEvent" method="post">
		...
		<table style="width: 100%; margin: 10px auto; border-spacing: 0px;">
		   <tr height="40">
		      <td align="left" width="100">
		          <button type="button" class="btn" onclick="javascript:location.href='<%=cp%>/store/event/listEvent';">새로고침</button>
				</td>
		      
		              
		      <td align="right" width="100">
		          <button type="button" class="btn" onclick="javascript:location.href='<%=cp%>/store/event/insertEvent';">글올리기</button>
		      </td>
		   </tr>
		</table>
